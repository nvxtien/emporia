...
- **Fixed-Point Primitive Math Micro-Benchmark**:
  - Added `FixedPointMathBenchmarkTest`, an informal comparison of primitive 64-bit `long` fixed-point arithmetic vs `BigDecimal`. Not a JMH benchmark; no verified performance figure is published from it.
