...
class JdbcFixSessionStateStore implements FixSessionStateStore {
    ...
    @Autowired
    JdbcFixSessionStateStore(@Qualifier("executionJdbcTemplate") JdbcTemplate jdbc) {
        this(jdbc, Clock.systemUTC());
    }

    JdbcFixSessionStateStore(@Qualifier("executionJdbcTemplate") JdbcTemplate jdbc, Clock clock) {
        this.jdbc = jdbc;
        this.clock = clock;
    }
