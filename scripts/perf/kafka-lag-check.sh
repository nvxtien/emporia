...
#   KAFKA_LAG_WARN_THRESHOLD    per-group total lag that prints a warning (100)
#   KAFKA_LAG_FAIL_THRESHOLD    per-group total lag that fails the check (1000)
...
WARN_THRESHOLD="${KAFKA_LAG_WARN_THRESHOLD:-100}"
FAIL_THRESHOLD="${KAFKA_LAG_FAIL_THRESHOLD:-1000}"
